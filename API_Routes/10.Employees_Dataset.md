...
| **`GET`** | `/employees/activity` | Fetch recent employee activity logs |
| **`GET`** | `/employees/live-search` | Implement live employee search API |
| **`GET`** | `/employees/dashboard/summary` | Generate dashboard summary analytics |
| **`GET`** | `/employees/dashboard/projects` | Generate project analytics dashboard |
| **`GET`** | `/employees/dashboard/tasks` | Generate task analytics dashboard |
| **`GET`** | `/employees/dashboard/skills` | Generate skills analytics dashboard |
| **`GET`** | `/employees/dashboard/certifications` | Generate certifications analytics dashboard |
| **`GET`** | `/employees/dashboard/geo` | Generate geo analytics dashboard |
| **`GET`** | `/employees/dashboard/performance` | Generate employee performance dashboard |
